...
- [S004.01 - Ratatui Application Scaffold](./S004.01-ratatui-application-scaffold.md) -
  TUI foundation
- [S004.02 - Main Dashboard Layout](./S004.02-main-dashboard-layout.md) - Main view to
  overlay
- [S004.03 - Keyboard Navigation](./S004.03-keyboard-navigation.md) - Enter key
  triggers detail
- [S002.03 - Session State History](./S002.03-session-state-history.md) - History data
  model
