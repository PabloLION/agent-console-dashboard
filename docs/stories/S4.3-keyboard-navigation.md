...
4. Implement Enter to expand detail view (triggers S4.4)
...
- [S4.2 - Main Dashboard Layout](./S4.2-main-dashboard-layout.md) - Session list
  rendering
- [S8.2 - RESURRECT Command](./S8.2-resurrect-command.md) - For resurrect action
  (optional, can stub)
...
- Detail view implementation (S4.4)
