...
5. Return raw JSON response for parsing in S044
...
- [S041 - macOS Credential Fetch](./S041-macos-credential-fetch.md)
- [S042 - Linux Credential Fetch](./S042-linux-credential-fetch.md)
