...
The RESURRECT command (S8.2) prepares the resurrection and validates
...
- [S8.2 - RESURRECT Command](./S8.2-resurrect-command.md) - Provides command
  infrastructure
- [S6.2 - User Prompt Submit Hook](./S6.2-user-prompt-submit-hook.md) - Detects
  session activity
