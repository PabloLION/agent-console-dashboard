...
- [S1.1 - Create Daemon Process](./S1.1-create-daemon-process.md) - Shares CLI
  entry point
- [S3.1 - IPC Message Protocol](./S3.1-ipc-message-protocol.md) - Will need IPC
...
- Main dashboard layout rendering (S4.2)
- Keyboard navigation (S4.3)
- Session detail view (S4.4)
- Widget system integration (E005)
- Actual daemon connection (deferred to S4.2)
