...
Moved to E010 **Priority:** P2 **Estimated Points:** 5

> **Note:** This story was moved to E010 as
> [S010.03](./S010.03-claude-resume-in-terminal.md). The terminal/pane execution
> concern belongs in Zellij Integration, not Session Resurrection protocol.
...
The RESURRECT command (S008.02) prepares the resurrection and validates
...
- [S008.02 - RESURRECT Command](./S008.02-resurrect-command.md) - Provides
  command infrastructure
- [S006.02 - User Prompt Submit Hook](./S006.02-user-prompt-submit-hook.md) -
  Detects session activity
