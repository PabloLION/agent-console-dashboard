...
The hook scripts (S6.1-S6.3) need to be registered in Claude Code's settings
...
- [S6.1 - Stop Hook Script](./S6.1-stop-hook-script.md) - Hook scripts must
  exist
- [S6.2 - User Prompt Submit Hook](./S6.2-user-prompt-submit-hook.md) - Hook
  scripts must exist
- [S6.3 - Notification Hook Script](./S6.3-notification-hook-script.md) - Hook
  scripts must exist
