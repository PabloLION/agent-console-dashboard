...
# Initial Response
{"type":"STATE","sessions":[{"id":"abc123","status":"working","elapsed":0}]}

# Subsequent Updates (pushed by daemon)
{"type":"UPDATE","session":"abc123","status":"working","elapsed":0}
{"type":"UPDATE","session":"abc123","status":"attention","elapsed":45}
{"type":"UPDATE","session":"def456","status":"question","elapsed":5}

# On session removal
{"type":"UPDATE","session":"abc123","status":"closed","elapsed":120}
```
