...
- [S009.01 - Integrate claude-usage Crate](./S009.01-integrate-claude-usage-crate.md) —
...
- [ ] Given usage data is unavailable, when the dashboard renders, then "Quota:
...
[D3 decision](../architecture/2026-01-31-discussion-decisions.md#d3-widget-data-flow---fully-centralized-via-daemon)
and
[widget-data-flow.md](../architecture/widget-data-flow.md#widget-constraints):
