...
With the API usage data model (S009.01) and IPC commands (S009.02) in place, the TUI
...
widget defined in S005.04 (E005 Widget System).
...
- [S004.04 - Session Selection and Detail View](./S004.04-session-selection-detail-view.md)
  \- Session detail view
- [S005.04 - API Usage Widget](./S005.04-api-usage-widget.md) - Widget implementation
  for rendering usage
- [S009.01 - API Usage Data Model](./S009.01-api-usage-data-model.md) - ApiUsage
  struct
- [S009.02 - API_USAGE Command](./S009.02-api-usage-command.md) - IPC commands for
  querying usage
