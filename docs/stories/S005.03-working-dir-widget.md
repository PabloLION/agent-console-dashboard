...
1. Create `crates/agent-console-dashboard/src/widgets/working_dir.rs`
...
- `crates/agent-console-dashboard/src/widgets/working_dir.rs` - WorkingDirWidget
  implementation
