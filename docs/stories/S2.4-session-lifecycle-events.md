...
This story integrates the data model (S2.1), status transitions (S2.2), and
state history (S2.3) into a cohesive lifecycle management system.
...
- [S2.3 - Session State History](./S2.3-session-state-history.md) - History
  recording must work
