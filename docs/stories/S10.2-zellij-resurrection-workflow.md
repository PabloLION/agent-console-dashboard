...
context, building on the Zellij layout integration (S10.1) and the core
resurrection command (S8.2).
...
- [S8.1 - Store Session Metadata for Closed Sessions](./S8.1-closed-session-metadata.md)
  \- Closed session data
- [S8.2 - Implement RESURRECT Command](./S8.2-resurrect-command.md) - Core
  resurrection IPC command
- [S8.3 - Integrate with claude --resume](./S8.3-claude-resume-integration.md) -
  Claude Code resume command
- [S10.1 - Zellij Layout with Dashboard Pane](./S10.1-zellij-layout-dashboard.md) -
