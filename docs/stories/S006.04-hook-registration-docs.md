...
The hook scripts (S006.01-S006.03) need to be registered in Claude Code's settings
...
- [S006.01 - Stop Hook Script](./S006.01-stop-hook-script.md) - Hook scripts must
  exist
- [S006.02 - User Prompt Submit Hook](./S006.02-user-prompt-submit-hook.md) - Hook
  scripts must exist
- [S006.03 - Notification Hook Script](./S006.03-notification-hook-script.md) - Hook
  scripts must exist
