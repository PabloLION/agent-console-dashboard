...
macOS Keychain may prompt for access approval. See
[macOS Keychain ACL documentation](../../docs/macos-keychain-acl.md) for details
on how Keychain access control lists affect credential retrieval.
