...
- `src/config/mod.rs` - Create config module with schema types
- `src/config/schema.rs` - Define configuration structs
...
- Loading configuration from file system (S028)
- XDG path resolution (S029)
- Creating default configuration file on disk (S030)
