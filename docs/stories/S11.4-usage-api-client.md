...
5. Return raw JSON response for parsing in S11.5
...
- [S11.2 - macOS Credential Fetch](./S11.2-macos-credential-fetch.md)
- [S11.3 - Linux Credential Fetch](./S11.3-linux-credential-fetch.md)
