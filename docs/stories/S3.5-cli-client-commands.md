...
- Auto-starts the daemon if not running (see S1.4)
...
- [S1.1 - Create Daemon Process](./S1.1-create-daemon-process.md) - CLI
  structure
- [S1.4 - Daemon Auto-Start](./S1.4-daemon-auto-start.md) - Auto-start if needed
- [S3.1 - IPC Message Protocol](./S3.1-ipc-message-protocol.md) - Protocol to
  use
- [S3.2 - SET Command](./S3.2-set-command.md) - Server-side handler
- [S3.3 - LIST Command](./S3.3-list-command.md) - Server-side handler
- [S3.4 - SUBSCRIBE Command](./S3.4-subscribe-command.md) - Server-side handler
