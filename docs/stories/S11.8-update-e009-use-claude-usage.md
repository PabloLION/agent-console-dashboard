...
1. Review E009 epic and stories (S9.1, S9.2, S9.3) for overlap with E011
...
- `docs/stories/S9.1-api-usage-data-model.md` - Reference claude-usage types
- `docs/stories/S9.2-api-usage-command.md` - Use claude-usage for data fetch
- `docs/stories/S9.3-api-usage-tui-display.md` - Minor updates if needed
- `docs/plans/6-open-questions.md` - Update Q34 to reference E011 completion

### Dependencies

- [S11.6 - Publish to crates.io](./S11.6-publish-crates-io.md) - Crate must be
