...
impl UsagePeriod {
    ...
    pub fn time_until_reset(&self) -> chrono::TimeDelta {
    ...
    /// # Returns
    ///
    /// Percentage (0.0 - 100.0) of the period that has elapsed.
...
mod tests {
    ...
    fn test_time_elapsed_percent_at_start() {
        ...
        let elapsed = period.time_elapsed_percent(5);
    ...
    fn test_time_elapsed_percent_at_half() {
        ...
        let period = UsagePeriod {
            utilization: 50.0,
            resets_at: Utc::now() + Duration::minutes(150), // 2.5 hours
        };
        let elapsed = period.time_elapsed_percent(5);
        assert!(
    ...
    fn test_five_hour_on_pace() {
        ...
        assert!(usage.five_hour_on_pace());
    }
    ...
    fn test_seven_day_on_pace() {
        ...
        assert!(usage.seven_day_on_pace());
    }
